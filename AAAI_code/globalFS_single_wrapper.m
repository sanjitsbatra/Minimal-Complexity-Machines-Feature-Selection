...
%Matlab wrapper for the Matlab mex single-thread GlobalFS
%Input:
...
function best_FS =globalFS_single_wrapper(data,C,alpha)
...
nthreads=1;
best_FS =globalFS_single([data,C],penalty,chi,nthreads,alpha);