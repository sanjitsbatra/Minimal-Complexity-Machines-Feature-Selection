function bcr = balancedErrorRate(trueY, predictedY, ranking) 
...
bcr = 100*(1-ber); % NOTE THAT WE ARE RETURNING BALANCED CLASSIFICATION RATE 
% INSTEAD OF RETURNING BER, SO THAT "HIGHER IS BETTER HOLDS"
